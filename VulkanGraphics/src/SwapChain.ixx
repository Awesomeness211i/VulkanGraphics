...
namespace Florencia {
	...
	SwapChain::SwapChain(Device& deviceRef, VkExtent2D extent, std::shared_ptr<SwapChain> previous) : m_Device{ deviceRef }, m_WindowExtent{ extent }, m_PreviousSwapChain{ previous } {
		Init();
